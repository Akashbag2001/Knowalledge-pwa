...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-gray-200 relative">
      {/* Background Grid */}
      <div className="absolute inset-0 bg-grid-dark [background-size:50px_50px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]" />

      {/* Floating elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-900/30 rounded-full blur-3xl" />
        <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-purple-900/30 rounded-full blur-3xl" />
